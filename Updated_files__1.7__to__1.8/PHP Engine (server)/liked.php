<?php
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                ?>
                    ...
                    <div class="row more_cont">
                        <div class="col s12">
                            <a href="javascript:void(0)" onclick="Liked.moreItems('<?php echo $result['itemId']; ?>'); return false;">
    ...
    $page_title = $LANG['page-i-liked']." | ".APP_TITLE;
    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <h2 class="header"><?php echo $LANG['page-i-liked']; ?></h2>

                        <div class="col s12 m12 l12 left liked_cont" style="padding-right: 0; padding-left: 0;">
        ...
        <script type="text/javascript">
            ...
            Liked.moreItems = function (offset) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if (response.hasOwnProperty('html')){
                            ...
                            $("div.liked_cont").append(response.html);
                        }
