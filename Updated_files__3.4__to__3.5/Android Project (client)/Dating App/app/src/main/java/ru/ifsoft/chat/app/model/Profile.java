...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int sex_orientation, age, height, weight, state, sex, year, month, day, verify, pro, itemsCount, likesCount, giftsCount, friendsCount, followingsCount, followersCount, photosCount, allowPhotosComments, allowShowMyBirthday, allowMessages, lastAuthorize;
