                ...
                <div class="row msg-form">
                    ...
                    <form class="" action="/settings.php" method="POST">
                        ...
                        <div class="input-field col s12">
                            ...
                            <label for="u_height" class="active"><?php echo $LANG['label-height']." (".$LANG['label-cm'].")"; ?></label>
                        </div>

                        <div class="input-field col s12">
                            <input id="u_weight" type="number" size="3" name="u_weight" value="<?php echo $accountInfo['weight']; ?>">
                            <label for="u_weight" class="active"><?php echo $LANG['label-weight']." (".$LANG['label-kg'].")"; ?></label>
                        </div>
                        ...
                        <div class="input-field col s12">
                            <select name="gender">
                                <option disabled value="2" <?php if ($accountInfo['sex'] != SEX_FEMALE && $accountInfo['sex'] != SEX_MALE) echo "selected=\"selected\""; ?>><?php echo $LANG['label-select-gender']; ?></option>
