...
public interface Constants {
    ...
    public static final String BILLING_KEY = "435634563456dfstgsdtgesrt534w5345345345345";

    // Fortumo settings | Settings from In-App Purchasing for Android | See documentation

    public static String FORTUMO_SERVICE_ID = "3456345634563456";

    public static String FORTUMO_APP_SECRET = "3456345634563456";

    public static final String SENDER_ID = "3456345634563456";  //GOOGLE API Sender ID
