 ...
 */
	...
	try {
		...
		$sth = $dbo->prepare("CREATE TABLE IF NOT EXISTS users (
								  ...
								  allowShowMyInfo SMALLINT(6) UNSIGNED DEFAULT 1,
								  allowShowMyGallery SMALLINT(6) UNSIGNED DEFAULT 1,
								  allowShowMyFriends SMALLINT(6) UNSIGNED DEFAULT 1,
								  allowShowMyLikes SMALLINT(6) UNSIGNED DEFAULT 1,
								  allowShowMyGifts SMALLINT(6) UNSIGNED DEFAULT 1,
