...
public interface Constants {
    ...
    public static final String BILLING_KEY = "345634563456/8dpn/sfCqR6cLVF0ZKdzelwOhlx2YNhkQ4+w6e0xEljzLNYxLctVi7X+345634563456/345634563456+TRD+72EmZRYayZwoEAojUGeMHj9vGV7L8zYzzt9yMqXLoJMockfXETJavR1CFs83UoRUAs+xU4hCIdb9P/r9UCcFSgXk2wFxgYIV9jSzpzKdUwgwjgAenC+dFYG7PHm5Jl6J607qZWF7sns6tMmXs1sxD";

    // Fortumo settings | Settings from In-App Purchasing for Android | See documentation

    public static String FORTUMO_SERVICE_ID = "3456345634534gt354t";

    public static String FORTUMO_APP_SECRET = "435634563456";

    public static final String SENDER_ID = "3456345643563456";  //GOOGLE API Sender ID
