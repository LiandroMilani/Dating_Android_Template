...
public class BalanceActivity extends ActivityBase {
    ...
    static final String ITEM_SKU_1 = "ifsoft.co.uk.iap1";          // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = "ifsoft.co.uk.iap2";          // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = "ifsoft.co.uk.iap3";          // Change to: yourdomain.com.iap3
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBuyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setService(FORTUMO_SERVICE_ID, FORTUMO_APP_SECRET);
                builder.setDisplayString(getString(R.string.action_buy));
                builder.setProductName(getString(R.string.action_credits_name));                              // Consumable purchases are restored using this value
                builder.setType(MpUtils.PRODUCT_TYPE_CONSUMABLE);              // consumable items can be later restored
