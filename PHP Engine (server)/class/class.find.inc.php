...
class find extends db_connect
{
    ...
    private function getCount($queryText, $gender = 3, $online = 0, $photo = 0, $proMode = 0, $ageFrom = 18, $ageTo = 105, $sexOrientation = 0, $moderation = 1)
    {
        $queryText = "%".$queryText."%";
    ...
    public function query($queryText = '', $userId = 0, $gender = 3, $online = 0, $photo = 0, $proMode = 0, $ageFrom = 18, $ageTo = 105, $sexOrientation = 0, $moderation = 1)
    {
    ...
    public function preload($itemId = 0, $gender = 3, $online = 0, $photo = 0, $proMode = 0, $ageFrom = 18, $ageTo = 105, $sexOrientation = 0, $moderation = 1)
    {
        if ($itemId == 0) {
