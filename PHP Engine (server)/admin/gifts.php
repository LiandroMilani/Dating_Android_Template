                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40"  method="post" action="/admin/gifts.php" enctype="multipart/form-data">
...
<?php
    ...
    function draw($itemObj)
    {
        ...
        <tr data-id="<?php echo $itemObj['id']; ?>">
            ...
            <td><a href="/admin/gifts.php/?id=<?php echo $itemObj['id']; ?>&action=remove&access_token=<?php echo admin::getAccessToken(); ?>">Remove</a></td>
        </tr>
