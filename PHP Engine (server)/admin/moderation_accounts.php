<?php
    ...
    if (!empty($_POST)) {
        ...
        $result = $moderator->getNotModerated($itemId);
    ...
    $page_id = "accounts_moderation";

    $css_files = array("mytheme.css");
    $page_title = "Accounts Moderation | Admin Panel";
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Accounts Moderation</li>
                        </ol>
                    </div>
                </div>
                ...
                <?php
                    ...
                    $result = $moderator->getNotModerated(0);
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body collapse show">
                                        ...
                                        <p class="card-text">Approve - the user profile will be "moderated". The profile will be displayed in the search results and "Horgame", as well as the user will be able to send private messages</p>
                                    </div>
                                </div>

                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">Accounts Moderation</h4>
                                    </div>
                                    <div class="card-body collapse show">
        ...
        <script type="text/javascript">
            ...
            Stream.reject = function (offset, accessToken) {

                $.ajax({
                    type: 'GET',
                    url: '/admin/account_reject.php/?id=' + offset  + '&access_token=' + accessToken,
            ...
            Stream.approve = function (offset, accessToken) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/admin/account_approve.php/?id=' + offset  + '&access_token=' + accessToken,
                    data: 'itemId=' + offset + "&access_token=" + accessToken,
                    timeout: 30000,
                    success: function(response) {
            ...
            Stream.moreItems = function (offset) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/admin/moderation_accounts.php',
    ...
    function draw($item)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['id']; ?>">
                ...
                <td>
                    <h6><a href="/admin/profile.php?id=<?php echo $item['id']; ?>"><?php echo $item['fullname']; ?></a></h6>
                ...
                <td>
                    ...
                    if (strlen($item['lowPhotoUrl']) != 0) {
                        ...
                        ?>
                        <img src="<?php echo $item['lowPhotoUrl']; ?>" alt="photo" width="180">
                        <?php
                ...
                <td>
                    <h6><?php echo $item['createDate']; ?></h6>
                </td>
                <td>
                    <a href="javascript:void(0)" onclick="Stream.reject('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>'); return false;" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Reject"><i class="ti-trash"></i> Reject</a>
                    <span> | </span>
