...
public interface Constants {
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkwer32455xoiLdiMowiu+yTWngk5G3DOY8tYKQIDAQAB";

    // Fortumo settings | Settings from In-App Purchasing for Android | See documentation

    public static String FORTUMO_SERVICE_ID = "3453f34f34f34";

    public static String FORTUMO_APP_SECRET = "34f34f34f3f43";
