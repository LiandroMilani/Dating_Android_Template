                ...
                switch ($account->getState()) {
                    ...
                    default: {
                        ...
                        if ($access_data['error'] === false) {
                            ...
                            auth::setSession($access_data['accountId'], $user_username, $account_fullname, $account_photo_url, $account_verify, $account_pro_mode, $account->getAccessLevel($access_data['accountId']), $access_data['accessToken']);
