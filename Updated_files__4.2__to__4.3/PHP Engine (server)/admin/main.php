                                ...
                                <div class="table-responsive">
                                    <table class="table product-overview">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-left">Total moderated accounts</td>
                                                <td><?php echo $stats->getModeratedAccountsCount(); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-left">Total accounts needing moderation</td>
                                                <td><?php echo $stats->getUnModeratedAccountsCount(); ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="text-left">Total moderated photos</td>
                                                <td><?php echo $stats->getModeratedPhotosCount(); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="text-left">Total photos needing moderation</td>
                                                <td><?php echo $stats->getUnModeratedPhotosCount(); ?></td>
                                            </tr>
        ...
        ?>
            ...
            <tr>
                <td style="width:50px;">
                    ...
                    <a href="/admin/profile.php?id=<?php echo $user['id']; ?>">
                        <?php
                ...
                <td>
                    <h6><a href="/admin/profile.php?id=<?php echo $user['id']; ?>"><?php echo $user['fullname']; ?></a></h6>
