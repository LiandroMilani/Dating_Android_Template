...
if (!empty($_POST)) {
    ...
    $moderation = isset($_POST['moderation']) ? $_POST['moderation'] : 1;
    ...
    $moderation = helper::clearInt($moderation);
    ...
    $result = $search->query($query, $userId, $gender, $online, $photo, $proMode, $ageFrom, $ageTo, $sex_orientation, $moderation);
