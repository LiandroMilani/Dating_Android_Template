...
public class SearchFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener {
    ...
    private int search_sex_orientation = 0, search_gender = -1, search_online = -1, search_moderation = 1, search_photo = -1, search_pro_mode = -1, search_age_from = 13, search_age_to = 110, preload_gender = -1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mHeaderSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                b.putInt("searchModeration", search_moderation);
    ...
    public void onCloseSettingsDialog(int searchGender, int searchOnline, int searchPhoto, int searchProMode, int searchAgeFrom, int searchAgeTo, int searchSexOrientation, int searchModeration) {
        ...
        search_moderation = searchModeration;
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("search_moderation", search_moderation);
    ...
    public void search() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_APP_SEARCH, null,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("moderation", Integer.toString(search_moderation));
