...
public class FinderFragment extends Fragment implements Constants {
    ...
    public void onCloseSettingsDialog(int searchGender, int searchOnline, int searchPhoto, int searchProMode, int searchAgeFrom, int searchAgeTo, int searchSexOrientation, int searchModeration) {
        ...
        SearchFragment p = (SearchFragment) adapter.getItem(1);
        p.onCloseSettingsDialog(searchGender, searchOnline, searchPhoto, searchProMode, searchAgeFrom, searchAgeTo, searchSexOrientation, searchModeration);
    }
