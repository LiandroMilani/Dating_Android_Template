...
public class SearchSettingsDialog extends DialogFragment implements Constants {
    ...
    CheckBox genderMaleCheckBox, genderFemaleCheckBox, onlineCheckBox, photoCheckBox, proModeCheckBox, moderationCheckBox;
    Spinner ageTo, ageFrom, sexOrientationSpinner;

    private int searchGender, searchOnline, searchPhoto, searchProMode, searchAgeFrom, searchAgeTo, searchSexOrientation, searchModeration;
    ...
    public interface AlertPositiveListener {
        ...
        public void onCloseSettingsDialog(int searchGender, int searchOnline, int searchPhoto, int searchProMode, int searchAgeFrom, int searchAgeTo, int searchSexOrientation, int searchModeration);
    }
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onCloseSettingsDialog(searchGender, searchOnline, searchPhoto, searchProMode, searchAgeFrom, searchAgeTo, searchSexOrientation, searchModeration);
        }
    };
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        searchModeration = bundle.getInt("searchModeration");
        ...
        moderationCheckBox = (CheckBox) view.findViewById(R.id.moderationCheckBox);
        ...
        setModeration(searchModeration);
            ...
            public void onShow(DialogInterface dialog) {
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        d.dismiss();
                        alertPositiveListener.onCloseSettingsDialog(getGender(), getOnline(), getPhoto(), getProMode(), getAgeFrom(), getAgeTo(), sexOrientationSpinner.getSelectedItemPosition(), getModeration());
                    }
                });
    ...
    public int getModeration() {
        ...
        if (moderationCheckBox.isChecked()) {
    ...
    public void setModeration(int moderation) {
        ...
        if (moderation == 1) {
            ...
            moderationCheckBox.setChecked(true);

        } else {

            moderationCheckBox.setChecked(false);
        }
    }
