...
public interface Constants {
    ...
    public static final String BILLING_KEY = "MGds/xtji5xoiLdiMowiu+yTWngk5G3DOY8tYKQIDAQAB";

    // Fortumo settings | Settings from In-App Purchasing for Android | See documentation

    public static String FORTUMO_SERVICE_ID = "45634563456345g345g435tg453g";

    public static String FORTUMO_APP_SECRET = "435g43g43g435g435g345g345g";

    public static final String SENDER_ID = "345345345";  //GOOGLE API Sender ID
