...
class photos extends db_connect
{
    ...
    public function add($mode, $comment, $originImgUrl = "", $previewImgUrl = "", $imgUrl = "", $photoArea = "", $photoCountry = "", $photoCity = "", $photoLat = "0.000000", $photoLng = "0.000000")
    {
    ...
    public function remove($photoId)
    {
        ...
        if ($stmt->execute()) {
            ...
            $stmt2->bindParam(":postId", $photoId, PDO::PARAM_INT);
            $stmt2->execute();
