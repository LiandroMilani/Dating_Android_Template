            ...
            <li class="card-item classic-item default-item chat-item" data-id="<?php echo $chat['id']; ?>">
                <div class="card-body">
                    <span class="card-header">
                        <a href="/profile.php?id=<?php echo $chat['withUserId']; ?>">
                        ...
                        <div class="card-content">
                            <span class="card-title">
                                <a href="/profile.php?id=<?php echo $chat['withUserId']; ?>"><?php echo $chat['withUserFullname']; ?></a>
                                    <?php
                            ...
                            <span class="card-action">
                                ...
                                <a href="/chat.php?chat_id=<?php echo $chat['id']; ?>&user_id=<?php echo $chat['withUserId']; ?>" class="card-act active"><?php echo $LANG['action-go-to-conversation']; ?></a>
                            </span>
                        </div>
                    </span>
                </div>
