...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Photos Stream</li>
                        </ol>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            Stream.remove = function (offset, accessToken, fromUserId) {

                $.ajax({
                    type: 'GET',
                    url: '/admin/photo_remove.php/?id=' + offset  + '&access_token=' + accessToken + '&fromUserId=' + fromUserId,
    ...
    function draw($item)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['id']; ?>">
                ...
                <td>
                    <a href="javascript:void(0)" onclick="Stream.remove('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>', '<?php echo $item['fromUserId']; ?>'); return false;" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Delete"><i class="ti-trash"></i></a>
                </td>
            </tr>
