                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/profile.php?id=<?php echo $accountId; ?>"><?php echo $accountInfo['fullname']; ?></a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40"  method="post" action="/admin/personal_gcm.php?id=<?php echo $accountId; ?>">
