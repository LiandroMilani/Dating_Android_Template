...
public class App extends Application implements Constants {
    ...
    private long id;
    private int state, admob, verify, balance, vip, ghost, pro, freeMessagesCount, allowShowMyAge, allowShowMySexOrientation, allowShowOnline, allowShowMyInfo, allowShowMyGallery, allowShowMyFriends, allowShowMyLikes, allowShowMyGifts, allowPhotosComments, allowComments, allowMessages, allowMatchesGCM, allowLikesGCM, allowCommentsGCM, allowFollowersGCM, allowMessagesGCM, allowGiftsGCM, allowCommentReplyGCM, errorCode, currentChatId = 0, notificationsCount = 0, messagesCount = 0, guestsCount = 0, newFriendsCount = 0, newMatchesCount = 0;
