...
class find extends db_connect
{
    ...
    private function getCount($queryText, $gender = -1, $online = -1, $photo = -1, $proMode = -1, $ageFrom = 13, $ageTo = 110, $sexOrientation = 0)
    {
        $queryText = "%".$queryText."%";
    ...
    public function query($queryText = '', $userId = 0, $gender = -1, $online = -1, $photo = -1, $proMode = -1, $ageFrom = 13, $ageTo = 110, $sexOrientation = 0)
    {
    ...
    public function preload($itemId = 0, $gender = -1, $online = -1, $photo = -1, $proMode = -1, $ageFrom = 13, $ageTo = 110, $sexOrientation = 0)
    {
        if ($itemId == 0) {
