                            ...
                            <div class="col s12" style="margin-top: 20px">
                                <?php
                                    ...
                                    if ($default == 1) {
                                        ...
                                        ?>
                                            <a href="/admin/admob.php/?access_token=<?php echo admin::getAccessToken(); ?>&act=global_on">
                                                <button class="btn waves-effect waves-light teal">Turn On AdMob for new users</button>
                                            </a>
                                        <?php
