            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                ?>
                    ...
                    <header class="top-banner loading-banner">
                        ...
                        <div class="prompt">
                            <button onclick="Liked.moreItems('<?php echo $result['itemId']; ?>'); return false;" class="button more loading-button"><?php echo $LANG['action-more']; ?></button>
                        </div>
            ...
            <div class="main-content">
                ...
                <div class="standard-page tabs-content">
                    <div class="tab-container">
                        <nav class="tabs">
                            <a href="/account/likes"><span class="tab"><?php echo $LANG['tab-likes']; ?></span></a>
                            <a href="/account/liked"><span class="tab active"><?php echo $LANG['tab-liked']; ?></span></a>
                        </nav>
                    </div>
                </div>
